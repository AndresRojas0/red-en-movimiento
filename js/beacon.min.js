(() => {
    var t = {
                ...
                !(function (t) {
                    ...
                    class e {
                        ...
                        l(t) {
                            ...
                            const e = this.i[0],
                                n = this.i.at(-1);
                            this.o && e && n && t.startTime - n.startTime < 1e3 && t.startTime - e.startTime < 5e3
                            ...
                            try {
                                for (; 9 !== t?.nodeType; ) {
                                    const n = t,
                                        i = n.id
                                            ? "#" + n.id
                                            : [o(n), ...Array.from(n.classList ?? []).sort()].join(".");
                            ...
                            return (a) => {
                                e.value >= 0 &&
                                    ...
                                    (r || void 0 === o) &&
                                        ...
                                        (e.delta = r),
                                        (e.rating = ((t, e) =>
                                            t > e[1] ? "poor" : t > e[0] ? "needs-improvement" : "good")(e.value, n)),
                                        t(e)));
                            };
                        },
                        f = (t) => {
                    ...
                    const v = new Set(),
                        ...
                        y = (t) => {
                            if ("hidden" === document.visibilityState) {
                                ...
                                isFinite(p) ||
                                    ((p = "visibilitychange" === t.type ? t.timeStamp : 0),
                                ...
                                const t = g(),
                                    e = document.prerendering
                                        ...
                                        : globalThis.performance
                                              ...
                                              .find((e) => "hidden" === e.name && e.startTime >= t)?.startTime;
                                (p = e ?? m()),
                                ...
                                if (i.length > 0) {
                                    const t = new PerformanceObserver((t) => {
                                        queueMicrotask(() => {
                                            ...
                                            i.length > 1 &&
                                                n.sort((t, e) => t.startTime + t.duration - (e.startTime + e.duration)),
                                                e(n);
                                        });
                                    });
                                    for (const e of i) t.observe({ type: e, buffered: !0, ...n });
                                    return t;
                                }
                            } catch {}
                        },
                                    ...
                                    for (const e of t)
                                        "first-contentful-paint" === e.name &&
                                            ...
                                            e.startTime < o.firstHiddenTime &&
                                                ((a.value = Math.max(e.startTime - g(), 0)),
                                                a.entries.push(e),
                                                (a.navigationId = e.navigationId || a.navigationId),
                                                r(!0)));
                                });
                                c &&
                                    ((r = u(t, a, x, e.reportAllChanges)),
                                    d((n) => {
                                        (a = T(
                                            "FCP",
                                            -1,
                                        ...
                                        S(
                                            ...
                                            (n) => {
                                                n.forEach((n) => {
                                                    ...
                                                    const o = Math.max(
                                                        (n.presentationTime || n.paintTime || 0) - n.startTime,
                                                        0
                                                    );
                                                    (a = T(
                                                        "FCP",
                    ...
                    class B {
                        ...
                        S(t) {
                            ...
                            return !e || -1 !== n || ("soft-navigation" !== t && "back-forward-cache" !== t)
                                ? this.p[n]
                                : { k: 8, id: -1, entries: [] };
                        }
                        l(t) {
                            ...
                            if (n || this.p.length < 10 || t.duration > e.k) {
                                if (
                                    (n
                                        ? t.duration > n.k
                                            ? ((n.entries = [t]), (n.k = t.duration))
                                            : t.duration === n.k &&
                                              t.startTime === n.entries[0].startTime &&
                                              n.entries.push(t)
                                        : ((n = { id: t.interactionId, entries: [t], k: t.duration }),
                                          this.v.set(n.id, n),
                                          this.p.push(n)),
                                    this.p.sort((t, e) => e.k - t.k),
                                    this.p.length > 10)
                                ) {
                    ...
                    const F = (t) => {
                            ...
                            if ("hidden" === document.visibilityState) t();
                                ...
                                addEventListener("visibilitychange", a, { once: !0, capture: !0 }),
                                    (r = n(
                                        () => {
                                            removeEventListener("visibilitychange", a, { capture: !0 }), o();
                                        },
                                        { timeout: e }
                                    ));
                            }
                                    ...
                                    L(
                                        E(() => {
                                            ...
                                            const a = s(n, e),
                                                ...
                                                v = (t) => {
                                                    for (const e of t)
                                                        "soft-navigation" !== e.entryType ? a.l(e) : p(e);
                                                    g();
                                                },
                                                m = ["layout-shift"];
                        ...
                        (t.onFCP = (t, e = {}) => {
                            ...
                            b(e) && (o.u = new Map()),
                                L((e) => {
                                    t(
                                        ((t) => {
                                            let e = { timeToFirstByte: 0, firstByteToFCP: t.value, loadState: i(l()) };
                            ...
                            (n.m = (t) => {
                                ...
                                for (let o = a.length - 1; o >= 0; o--) {
                                    ...
                                    if (Math.abs(n - r.renderTime) <= 8) {
                                        (i = r),
                                            (i.startTime = Math.min(t.startTime, i.startTime)),
                                            (i.processingStart = Math.min(t.processingStart, i.processingStart)),
                                            (i.processingEnd = Math.max(t.processingEnd, i.processingEnd)),
                                            e.includeProcessedEventEntries && i.entries.push(t);
                                        break;
                                    }
                                }
                                i ||
                                ...
                                ((t, e = {}) => {
                                    ...
                                    P(() => {
                                        "interactionCount" in performance ||
                                            D ||
                                            (D = S(["event"], N, { durationThreshold: 0 }));
                                        let i,
                                            o = T("INP");
                                        const r = s(e, B),
                                            a = (n, a, s, c, l) => {
                                            ...
                                            g = (t, e = !1) => {
                                                F(() => {
                                                    for (const e of t)
                                                        "soft-navigation" !== e.entryType ? r.l(e) : f(e);
                                                    c(), e && i(!0);
                                                });
                                            },
                                            p = ["event", "first-input"];
                                        b(e) && p.push("soft-navigation");
                                        const v = S(p, g, { ...e, durationThreshold: e.durationThreshold ?? 40 });
                                        (i = u(t, o, j, e.reportAllChanges)),
                                            v &&
                                                (n.onHidden(() => {
                                                    g(v.takeRecords(), !0);
                                            ...
                                            return (
                                                ((t) => {
                                                    ...
                                                    f >= e + i + o && (l = n - f),
                                                        ...
                                                        (t.totalStyleAndLayoutDuration = c),
                                                        (t.totalPaintDuration = l),
                                                        (t.totalUnattributedDuration = n - e - s - c - l);
                                                })(u),
                                                Object.assign(t, { attribution: u })
                                            );
                                        })(e)
                                    );
                                }, e);
                                ...
                                ((t, e = {}) => {
                                    ...
                                    P(() => {
                                        ...
                                        const c = s(e, _),
                                            p = (i, s, c, l, d) => {
                                                (a = T("LCP", -1, i, s, c, l, d)),
                                                    ...
                                                    (n = !1),
                                                    "soft-navigation" === i && (r = h(!0));
                                            },
                                            v = (t) => {
                                                c.u && t.navigationId && w(c.u, t),
                                                    n || o(!0),
                                                    p(
                                                        "soft-navigation",
                                                        t.navigationId,
                                            ...
                                            m = (t) => {
                                                ...
                                                for (const e of t) {
                                                    ...
                                                    if ("largest-contentful-paint" === e.entryType)
                                                        (t = Math.max(e.startTime - g(), 0)), c.l(e), (n = [e]);
                                                    else if ("interaction-contentful-paint" === e.entryType) {
                                                        const o = e;
                                                        if (!a.navigationId) continue;
                                                        if (
                                                            "interactionId" in o &&
                                                            o.interactionId != a.navigationInteractionId
                                                        )
                                                            continue;
                                                        (i = o.largestContentfulPaint?.renderTime || 0),
                                                            (t = Math.max(i - e.startTime, 0)),
                                                            o.largestContentfulPaint &&
                                                                (c.l(o.largestContentfulPaint),
                                                                (n = [o.largestContentfulPaint]));
                                                    }
                                        ...
                                        if (b) {
                                                        ...
                                                        F(() => {
                                                            if (!n) {
                                                                if (!i) {
                                                                    b.disconnect();
                                                                    for (const t of r)
                                                                        removeEventListener(t, s, { capture: !0 });
                                                                }
                                                                t === a.id && ((n = !0), o(!0));
                                                            }
                                                        });
                                            ...
                                            for (const t of r) addEventListener(t, s, { capture: !0 });
                                            d((i) => {
                                                p(
                                                    "back-forward-cache",
                                                    a.navigationId,
                                        ...
                                        ((t) => {
                                            ...
                                            if (t.entries.length) {
                                                const r = t.entries.at(-1),
                                                    a =
                                                        r.url &&
                                                        (U.findLast((t) => t.name === r.url) ||
                                                            performance
                                                                .getEntriesByType("resource")
                                                                .findLast((t) => t.name === r.url));
                                                let s;
                                                (e.target = o.get(r)),
                                                    (e.lcpEntry = r),
                                                    r.url && (e.url = r.url),
                                                    a && (e.lcpResourceEntry = a);
                                                let c = 0,
                                                    l = 0;
                                                if (
                                                    ("soft-navigation" !== t.navigationType
                                                        ? ((s = n()),
                                                          (c = s?.activationStart ?? 0),
                                                          (l = s?.responseStart ?? 0))
                                                        : ((c = t.navigationStartTime || 0),
                                                          (s = i.u?.get(t.navigationId))),
                                                    s)
                                                ) {
            ...
            674: (t, e) => {
                "use strict";
                Object.defineProperty(e, "__esModule", { value: !0 }),
                    (e.positiveOnlyFields = e.timingsV2TargetKeys = e.timingsTargetKeys = void 0),
                    (e.buildTimingsObject = function (t, n, i, o) {
                        if (void 0 !== n)
                            for (const r of i) {
                                const i = t[r];
                                if ("number" == typeof i) {
                    ...
                    (e.positiveOnlyFields = new Set(["secureConnectionStart", "redirectStart", "redirectEnd"]));
            },
            696: (t, e) => {
                "use strict";
                var n, i, o, r, a;
                Object.defineProperty(e, "__esModule", { value: !0 }),
                    ...
                    (function (t) {
                        (t[(t.Load = 1)] = "Load"),
                            (t[(t.Additional = 2)] = "Additional"),
                            (t[(t.WebVitalsV2 = 3)] = "WebVitalsV2");
                    })(i || (e.EventType = i = {})),
                    (function (t) {
                    ...
                    (function (t) {
                        (t[(t.None = 0)] = "None"),
                            (t[(t.HistoryAndNavigationAPI = 1)] = "HistoryAndNavigationAPI"),
                            (t[(t.SoftNavigationHeuristics = 2)] = "SoftNavigationHeuristics");
                    })(r || (e.SpaMonitoringType = r = {})),
                    (function (t) {
                        (t.Navigate = "navigate"),
                            (t.Reload = "reload"),
                            (t.BackForward = "back-forward"),
                            (t.BackForwardCache = "back-forward-cache"),
                            (t.Prerender = "prerender"),
                            (t.Restore = "restore"),
                            (t.SoftNavigation = "soft-navigation"),
                            (t.RoutingApis = "routing-apis");
                    })(a || (e.NavigationType = a = {}));
            },
            969: () => {
                "use strict";
                "function" != typeof Array.prototype.findLast &&
                    Object.defineProperty(Array.prototype, "findLast", {
                        value: function (t, e) {
                            for (let n = this.length - 1; n >= 0; n--) if (t.call(e, this[n], n, this)) return this[n];
                        },
                        writable: !0,
                        configurable: !0,
                        enumerable: !1,
            ...
            !(function () {
                const s =
                    ...
                    l =
                        ...
                        ("function" == typeof document.querySelector ? document.querySelector(`script[${c}]`) : void 0),
                ...
                const p = (t, e = {}) => {
                    ...
                    !e.referrer && f[f.length - 1] && (e.referrer = f[f.length - 1].url),
                        f.push({
                            id: u,
                            url: t,
                            ts: i,
                ...
                const y = (function (e) {
                        let n = e;
                        return null == n || "true" === n || !0 === n
                            ? t.SpaMonitoringType.HistoryAndNavigationAPI
                            : "false" === n || !1 === n
                              ? t.SpaMonitoringType.None
                              : ("string" == typeof n && (n = parseInt(n, 10)),
                                "number" == typeof n &&
                                n >= t.SpaMonitoringType.None &&
                                n <= t.SpaMonitoringType.SoftNavigationHeuristics
                                    ? n
                                    : t.SpaMonitoringType.HistoryAndNavigationAPI);
                    })(v.spa),
                                            ...
                                            return "Windows" === t
                                                ? i >= 13
                                                    ...
                                                    : i >= 1
                                                      ? "10"
                                                      : n[0]
                                                : ("iOS" === t || "macOS" === t) && n.length >= 2
                                                  ? n[0] + "." + n[1]
                                                  : n[0];
                                        })(
                                            (null === (n = navigator.userAgentData) || void 0 === n
                                                ? void 0
                                                : n.platform) || "",
                                            e.platformVersion
                                        ));
                ...
                function N(t) {
                    ...
                    var c;
                    let l;
                    switch (("INP" !== t.name && (k[t.name.toLowerCase()] = { value: t.value, path: s }), t.name)) {
                        case "CLS":
                            (l = t.attribution),
                                l &&
                                    k.cls &&
                                    ((k.cls.element = l.largestShiftTarget),
                                    (k.cls.currentRect =
                                        null === (e = l.largestShiftSource) || void 0 === e ? void 0 : e.currentRect),
                                    (k.cls.previousRect =
                                        null === (n = l.largestShiftSource) || void 0 === n ? void 0 : n.previousRect));
                            break;
                        case "LCP":
                            (l = t.attribution),
                                l &&
                                    k.lcp &&
                                    ((k.lcp.element = l.target),
                                    (k.lcp.size = null === (i = l.lcpEntry) || void 0 === i ? void 0 : i.size),
                                    (k.lcp.url = l.url),
                                    (k.lcp.rld = Math.ceil(l.resourceLoadDelay)),
                                    (k.lcp.rlt = Math.ceil(l.resourceLoadDuration)),
                                    (k.lcp.erd = Math.ceil(l.elementRenderDelay)),
                                    (k.lcp.it =
                                        null === (o = l.lcpResourceEntry) || void 0 === o ? void 0 : o.initiatorType),
                                    (k.lcp.fp =
                                        null === (a = null === (r = l.lcpEntry) || void 0 === r ? void 0 : r.element) ||
                                        void 0 === a
                                            ? void 0
                                            : a.getAttribute("fetchpriority")));
                            break;
                        case "INP":
                            (null == k.inp || Number(k.inp.value) < Number(t.value)) &&
                                ((k.inp = { value: Number(t.value), path: s }),
                                (l = t.attribution),
                                l &&
                                    k.inp &&
                                    ((k.inp.element = l.interactionTarget),
                                    (k.inp.name = l.interactionType),
                                    (k.inp.idy = Math.ceil(l.inputDelay)),
                                    (k.inp.pdn = Math.ceil(l.processingDuration)),
                                    (k.inp.pdy = Math.ceil(l.presentationDelay))));
                    }
                }
                "PerformanceObserver" in window &&
                    "function" == typeof PerformanceObserver &&
                    PerformanceObserver.supportedEntryTypes &&
                    ((0, i.onLCP)(N, { reportAllChanges: !0, reportSoftNavs: !0 }),
                    (0, i.onFCP)(N),
                    (0, i.onINP)(N, { reportSoftNavs: !0 }),
                    (0, i.onTTFB)(N),
                    PerformanceObserver.supportedEntryTypes &&
                        -1 !== PerformanceObserver.supportedEntryTypes.indexOf("layout-shift") &&
                        (0, i.onCLS)(N, { reportAllChanges: !0, reportSoftNavs: !0 })),
                ...
                const D = (i) => {
                        ...
                        let o = (function (e) {
                            const i = K(u) === t.NavigationType.RoutingApis || K(u) === t.NavigationType.SoftNavigation,
                                ...
                                l = Object.assign(Object.assign({}, z(t.EventType.Load, c)), {
                                    ...
                                    versions: { fl: v ? v.version : "", js: "2026.9.1", timings: 1 },
                                });
                            if (o) {
                                if ("function" == typeof s.getEntriesByType) {
                                    ...
                                    if (t && Array.isArray(t) && t.length > 0) {
                                        (l.timingsV2 = {}),
                                            ...
                                            delete l.timings,
                                            t[0].deliveryType && (l.dt = t[0].deliveryType);
                                        const e = t[0];
                                ...
                                if (1 === l.versions.timings) {
                                    const t = a;
                                    l.timings &&
                                        (0, r.buildTimingsObject)(t, l.timings, r.timingsTargetKeys, t.navigationStart);
                                }
                                s.memory
                                    ? (function (t, e) {
                                          for (const n in t) {
                                              const i = t[n];
                                              void 0 !== e &&
                                                  (("number" != typeof i && "string" != typeof i) || (e[n] = i));
                                          }
                                      })(s.memory, l.memory)
                                    : delete l.memory,
                                    (l.firstPaint = J("first-paint")),
                                    (l.firstContentfulPaint = J("first-contentful-paint"));
                            }
                            return (
                                v && (v.icTag && (l.icTag = v.icTag), (l.siteToken = v.token)),
                                i &&
                                    (delete l.timings,
                                    delete l.timingsV2,
                                    delete l.memory,
                                    delete l.firstPaint,
                                    delete l.firstContentfulPaint,
                                    delete l.serverTimings),
                                l
                            );
                        })(i);
                        o &&
                            v &&
                            v &&
                            ((0, e.sendObjectBeacon)("", o, () => {}, !1, b),
                            void 0 !== v.forward &&
                                void 0 !== v.forward.url &&
                                (0, e.sendObjectBeacon)("", o, () => {}, !1, v.forward.url));
                    },
                    R = (n) => {
                        let i = (function (e) {
                            ...
                            return (
                                v &&
                                    (v.version && (n.versions.fl = v.version),
                                    v.icTag && (n.icTag = v.icTag),
                                    (n.siteToken = v.token)),
                                k &&
                                    d.forEach((t) => {
                                        k[t] &&
                                            ...
                                            n[t] &&
                                                n[t].value &&
                                                (n[t].value = (0, a.roundWebVitalValue)(t, n[t].value)));
                                    }),
                                n
                            );
                        })(n);
                    ...
                    B = () => {
                        ...
                        t ? t.then(D) : D(), (M = { id: u, url: n(), ts: new Date().getTime(), triggered: !0 });
                    };
                ...
                var _, H;
                function V(t) {
                    for (let e = f.length - 1; e >= 0; e--) if (f[e].id === t) return f[e];
                }
                function U(t) {
                    var e;
                    if (t) {
                ...
                h &&
                    (y === t.SpaMonitoringType.SoftNavigationHeuristics &&
                        (T = (function () {
                            var e, n;
                            if (
                                !("PerformanceObserver" in window) ||
                                !PerformanceObserver.supportedEntryTypes ||
                                -1 === PerformanceObserver.supportedEntryTypes.indexOf("soft-navigation")
                            )
                                return null;
                            if (
                                "function" !=
                                typeof (null ===
                                    (n =
                                        null === (e = window.PerformanceSoftNavigation) || void 0 === e
                                            ? void 0
                                            : e.prototype) || void 0 === n
                                    ? void 0
                                    : n.getLargestInteractionContentfulPaint)
                            )
                                return null;
                            ...
                            try {
                                i.observe({ type: "soft-navigation", buffered: !0 });
                            } catch (t) {
                                return null;
                            }
                            return i;
                    ...
                    T ||
                        (y !== t.SpaMonitoringType.HistoryAndNavigationAPI &&
                            y !== t.SpaMonitoringType.SoftNavigationHeuristics) ||
                        ((S = (function () {
                            ...
                            let e = function (e) {
                                ...
                                e.canIntercept &&
                                    (R(m),
                                    !e.destination ||
                                    "boolean" != typeof e.destination.sameDocument ||
                                    e.destination.sameDocument
                                        ? (j(),
                                          (m =
                                              null !==
                                                  (i =
                                                      null === (n = null == e ? void 0 : e.destination) || void 0 === n
                                                          ? void 0
                                                          : n.url) && void 0 !== i
                                                  ? i
                                                  : m),
                                          p(m, { navigationType: t.NavigationType.RoutingApis }),
                                          D(m))
                                        : (A = !0));
                            };
                        ...
                        S ||
                            ((_ = window.history),
                            (H = _.pushState) &&
                                ((_.pushState = function (e, i, o) {
                                    const r = n(o);
                                    return (
                                        m != r &&
                                            (R(m),
                                            j(),
                                            p(r, { navigationType: t.NavigationType.RoutingApis }),
                                            D(r),
                                            (m = r)),
                                        H.apply(_, [e, i, o])
                                    );
                    ...
                    for (const e of ["navigation", "resource"])
                        for (const n of s.getEntriesByType(e)) {
                            ...
                            if (o) {
                                ...
                                for (const { name: n, description: r, duration: a } of o)
                                    if (v.serverTiming.name && v.serverTiming.name[n])
                                        try {
                                            const o = new URL(i);
                                            t.push({
                ...
                function J(t) {
                    ...
                    if ("function" == typeof s.getEntriesByType) {
                        const n =
                            null === (e = s.getEntriesByType("paint")) || void 0 === e
                                ? void 0
